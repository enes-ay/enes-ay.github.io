    ...
    <div className="bg-black min-h-screen flex flex-col justify-between">
      <header className="flex flex-col md:flex-row items-start md:justify-between w-full max-w-7xl mx-auto px-4 mt-10">
        <div className="flex-1">
          ...
          <div className="flex space-x-6 mt-4 animate-fadeInUp">
            <a
              href="https://www.linkedin.com/in/ayenes/"
              target="_blank"
      ...
      <main className="flex flex-col items-center w-full px-4">
        ...
        <section className="w-full max-w-7xl mb-20 mt-20">
          <h2 className="text-3xl md:text-4xl text-white text-center mb-16 font-semibold animate-fadeIn">
            My Projects
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Project 1 */}
            <div className="bg-black rounded-xl p-6 border-2 transition-transform transform hover:scale-105 hover:">
            ...
            {/* Project 3 */}
            <div className="bg-black rounded-xl p-6 transition-transform border-2 transform hover:scale-105 hover:">
              <div className="flex justify-center mb-4">
                <Image
                  src={imgFinancial}
                  width={250}
